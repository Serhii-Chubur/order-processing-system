...
import (
	...
	"order_processing_system/user_service/internal/server"
...
func Run() error {
	...
	// service
	userService := services.NewService(psqlRepo, redisRepo)
	...
	go func() {
		...
		if err != nil {
			...
			fmt.Println("User PSQL connection closed")
		}
